create database if not exists onemovies;
use onemovies;
...
create table if not exists listof(
...
insert into video(
                  ...
                  embed
                            ...
                            "Pokemon The Movie - The Power of Us - Full Trailer",
                            "Five strangers come together to save the day in Fula City when a series of threats endanger the annual Wind Festival and the city's entire population.",
                            '2018-12-06',
                            "DailyMotion",
                            NULL,
                            "https://www.dailymotion.com/embed/video/x6yhbne");
insert into video(video_id, title, description, publishdate, source, reviews, embed) values (1,"3+ Hours Of Horror Stories To Keep You Up All Night","TIMESTAMPS: 0:00 “Intro”,	0:22 “Every Fall My Family Plays The Better Behave Game”,	18:00 “The Rescue Mission Was In The No-Go Zone In Northern Alaska, That’s Why They Sent Me”,	38:27 “I Invented A List Of Strange Rules For My Stupid Office Job”",'2022-03-19',"Youtube",NULL,"https://www.youtube.com/embed/_9oueEOX2tI");
